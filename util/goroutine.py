...
from typing import Any, Iterable, Mapping, Generator, Callable

from .types import nullable, const, Number
...
class _GoThread(Thread):
    ...
    def __init__(self, channel: Channel, group: None = None, target: Callable = None, name: str = None,
        ...
        self._kwargs: nullable(Mapping[str, Any]) = kwargs or {}
...
class GoRoutine:
    ...
    def __init__(self, executor: _GoThread, chan: Channel):
    ...
    def stop(self, timeout: Number = None):
        self.channel.close()
        self.__executor.join(timeout)


def go(func: Callable, channel: Channel = None, *args, **kwargs) -> GoRoutine:
    """
